...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + DbProvider.FAVOURITES_TABLE_NAME + " (_id INTEGER PRIMARY KEY AUTOINCREMENT, SOURCE_TEXT TEXT, TRANSLATED_TEXT TEXT, LANG_CODE_SOURCE TEXT, LANG_CODE_TRANSLATION TEXT, HISTORY_ID INTEGER);");
    }
